...
<CardGroup cols={2}>
  ...
  <Card title="Xero" icon="dollar-sign" href="/connectors/xero">
    Invoices, contacts, bank transactions, chart of accounts.
  </Card>
  <Card title="QuickBooks Online" icon="dollar-sign" href="/connectors/quickbooks">
    Customers, invoices, expenses, reports.
  </Card>
  <Card title="MYOB AccountRight" icon="dollar-sign" href="/connectors/myob">
