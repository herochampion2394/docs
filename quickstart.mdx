...
<CardGroup cols={2}>
  <Card title="Microsoft Teams" icon="microsoft" href="/chat/teams">
...
<CardGroup cols={2}>
  ...
  <Card title="Chat in Teams" icon="microsoft" href="/chat/teams">
    Install the bot in Microsoft Teams.
  </Card>
  <Card title="Chat in Slack" icon="slack" href="/chat/slack">
